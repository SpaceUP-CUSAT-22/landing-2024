...
const Content2 = () => {
  ...
  const gridItems = [
    { image: 'speakers/speaker_5.jpg', description: `Dr. T N Suresh Kumar is a multifaceted individual whose career transcends the boundaries of traditional space science. While he excelled as a space scientist with a 38-year career at the Indian Space Research Organization (ISRO), his passions extended far beyond the cosmos.
