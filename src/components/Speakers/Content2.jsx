...
const Content2 = () => {
  ...
  const gridItems = [
    { image: 'speaker_1.jpg', description: `Dr. T N Suresh Kumar is a multifaceted individual whose career transcends the boundaries of traditional space science. While he excelled as a space scientist with a 38-year career at the Indian Space Research Organization (ISRO), his passions extended far beyond the cosmos.
...
Surendran has authored two astronomy-related books: "Nakshatragalum Nhattuveelaum," published by Mathrubhumi, and "Ammuvum Aakasamoongayum," published by Twinkle Books.` },
    { image: 'speaker_5.jpg', description: `Mr. Varun K is a dedicated space tech enthusiast and serves as the Team Lead at the UL Space Club,a registered space tutor of ISRO.He has conducted over 150 sessions at a young age, leading various projects. He also mentors students in space science and technology, coordinates science and technology programs, and engages with students across the nation. Additionally, he is the co-founder and CEO of Zeta Space, a startup focused on space research, and remains committed to continuous learning and innovation in emerging technologies.` },
    { image: 'speakers/speaker_6.jpg', description: `Mr. Ajison George, a Project Manager and UAV Analyst at an aerospace company, is a driven mechanical engineer with a strong passion for space science. He is at the forefront of groundbreaking research on the innovative use of UAVs in outer space. His deep enthusiasm for space has propelled him to an exceptional position at a remarkably young age. A philanthropist at heart, Ajison is dedicated to using technology to bring about meaningful, positive change in the world.` },
  ];
  ...
  {gridItems.map((item, i) => (
    ...
    >
      <div className='bg-red-800 bg-opacity-20 absolute inset-0'>
