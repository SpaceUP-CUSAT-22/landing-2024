  ...
  return (
    ...
    <div className="md:pt-0 pt-40 panel2 flex items-center justify-center w-[100vw] h-[100vh] text-white overflow-hidden relative px-5 md:px-20">
      ...
      <div className="grid md:grid-cols-3 grid-cols-1 items-center justify-center w-[100vw] h-[100vh] box-border">
        <div className="flex-1 p-5 box-border font-exo md:text-left text-center text-md md:text-xl">
          <p>{para1}</p>
        </div>
        <div className="relative z-[1] flex-2 flex flex-col items-center justify-center text-center box-border">
        ...
        <div className="hidden md:flex flex-1 p-5 box-border font-exo text-md md:text-xl">
          <p>{para2}</p>
        </div>
      </div>
    </div>
