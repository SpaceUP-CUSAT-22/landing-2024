...
const Card = ({ num }) => {
  return(
    <div className='card px-5 md:px-20 mt-20'>
      <div className='border-2 border-[#A6232B] bg-black px-5 md:px-20 py-10 md:py-20 rounded-[15px]'>
...
const Events = () => {
  ...
  return (
    <>
      <div className='panel1 w-[100vw] py-40 md:py-20'>
